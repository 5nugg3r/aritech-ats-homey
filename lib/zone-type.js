 ...
 */
const TYPE_CAPS = {
  motion: ['alarm_motion', 'alarm_generic', 'alarm_tamper', 'zone_active'],
  contact: ['alarm_contact', 'alarm_generic', 'alarm_tamper', 'zone_active'],
  fire: ['alarm_fire', 'alarm_tamper', 'zone_active'],
  generic: ['alarm_generic', 'alarm_tamper', 'zone_active'],
};
